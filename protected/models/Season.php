...
/**
 * This is the model class for table "hot_season".
 *
 * The followings are the available columns in table 'hot_season':
 * @property integer $id
...
class Season extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('season, begin, end, id_hotel', 'required'),
			array('id_hotel', 'numerical', 'integerOnly'=>true),
			array('season', 'length', 'max'=>255),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, season, begin, end, id_hotel', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'rates' => array(self::HAS_MANY, 'Rate', 'id_season'),
