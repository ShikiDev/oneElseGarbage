...
class SeasonController extends Controller
{
    ...
    /**
     * @return object $list возвращает результат запроса на получение списка отелей
     */
	protected function getListHotel()
    {
        $list = Hotel::model()->findAll();
        return $list;
