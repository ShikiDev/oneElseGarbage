...
class RateController extends Controller
{
    ...
    /**
     * @return object $list возвращает результат запроса на получение списка сезонов
     */
    protected function getListSeason()
    {
        $list = Season::model()->findAll();
        return $list;
